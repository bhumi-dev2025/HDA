          ...
          >
            ...
            <View style={{ flex: 1, paddingHorizontal: 20, paddingTop: 32 }}>
              ...
              <View style={{ alignItems: "center", marginBottom: 32 }}>
                ...
                >
                  Enter your Google AI Studio API key to enable the AI Chat
                  feature. It is stored securely on your device and never shared
                  with anyone except Google's services.
                </Text>
              </View>
            ...
            >
              ...
              >
                <Text
                  style={{ color: "#FF453A", fontSize: 14, fontWeight: "500" }}
                >
                  Remove Key
                </Text>
              </TouchableOpacity>
