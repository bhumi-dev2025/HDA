  ...
  async function getProfile() {
    try {
      ...
      if (session) {
        ...
        setUsername(
          session.user.user_metadata?.full_name || "Human Design User",
        );
      }
    } catch (error: any) {
      ...
      <ImageBackground source={homeBg} resizeMode="cover" style={{ flex: 1 }}>
        <SafeAreaView className="flex-1">
          ...
          >
            ...
            >
              <TouchableOpacity
                onPress={() => router.push("/setting_Screens/notifications")}
                className="flex-row items-center justify-between p-5"
              >
                <Text className="text-base font-semibold text-white">
                  Notification
            ...
            >
              <TouchableOpacity
                onPress={() => router.push("/setting_Screens/health")}
                className="flex-row items-center justify-between p-5"
              >
                <Text className="text-base font-semibold text-white">
                  Health Details
              ...
              />
              <TouchableOpacity
                onPress={() => router.push("/setting_Screens/change")}
                className="flex-row items-center justify-between p-5"
              >
                <Text className="text-base font-semibold text-white">
                  Change Goals
              ...
              />
              <TouchableOpacity
                onPress={() => router.push("/setting_Screens/unit")}
                className="flex-row items-center justify-between p-5"
              >
                <Text className="text-base font-semibold text-white">
                  Unit of Measure
            ...
            >
              ...
              />
              <TouchableOpacity
                onPress={() => router.push("/setting_Screens/account")}
                className="flex-row items-center justify-between p-5"
              >
                <Text className="text-base font-semibold text-white">
                  Manage Account
            ...
            <View className="items-center pb-10">
              ...
              <Text className="text-[10px] text-[#636366] mt-1">
